...
const {JSDOM} = jsdom;
const dom = new JSDOM('<!DOCUMENT html><p>Test</p>', {url:'https://www.zhihu.com/'})
...
// navigator.userAgent = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/101.0.0.0 Safari/537.36'

window._resourceLoade = undefined
...
Object.prototype.toString = function () {
    let _xl = object_toString.call(this, arguments)
...
function run (t){
    // t = md5('101_3_3.0+/api/v4/comment_v5/answers/371937534/root_comment?order_by=score&limit=20&offset=+AMAYTzODaRaPThnQrdB1r4Ny0gmKMWor2uY=|1677817946')
    return D(t)
